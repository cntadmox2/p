...
const whiteList =['https://mkjdev.com','http://localhost:4200','http://localhost:3100','http://192.168.0.10:4200','http://localhost','https://miwe.onrender.com','http://mkjdev.com']; //no sirve si es pedido por un server backend

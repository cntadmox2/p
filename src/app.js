...
const whiteList =['http://localhost:4200','http://localhost:3100','http://192.168.0.10:4200','http://localhost','https://miwe.onrender.com','https://mkjdev.com','mkjdev.com']; //no sirve si es pedido por un server backend
...
setInterval(() => {
    ...
    files.forEach(function(file, index) {
        ...
        endTime = new Date(stat.ctime).getTime() + 650000;
        if (now > endTime) {
